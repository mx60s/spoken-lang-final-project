# From https://github.com/gatheluck/pytorch-SelectiveNet/blob/master/selectivenet/loss.py
# Will probably need to change to fit the HuggingFace trainer schema
